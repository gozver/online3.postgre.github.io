    ...
    <section class='container rounded'>
        ...
        <table class='w-100'>
            <tr><td><p> <a class='breadcrumb-item' href='../../index.html'>Enunciado</a>
                        ...
                        <a class='breadcrumb-item gray' disabled>Mostrar Balance</p>
                </td>
                <td>
        ...
        <ul class='nav nav-tabs text-center'>
            <li class='nav-item w20'><a class='nav-link white active' href='./index.php'>Listar</a></li>
        ...
        <!-- PÁGINA -->
        <h1 class='display-5 text-center'>Listar contenido.</h1><br /> <?php
        ...
        <table class='custom'>
            <thead>
                <tr class='dark-blue center'><th colspan=6>LISTAR</th></tr>
            ...
            <tbody> <?php                
                ...
                <tr>
                    ...
                    <th colspan=4><?= $total_ing - $total_gas; ?></th>                    
