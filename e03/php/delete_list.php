...
<body>
    ...
    <section class='container rounded'>
        ...
        <ul class='nav nav-tabs text-center'>
            ...
            <li class='nav-item w20'><a class='nav-link white active' href='./delete_list.php'>Eliminar</a></li>
        </ul><br />
        
        <!-- PÁGINA -->
        <h1 class='display-5 text-center'>Eliminar contenido.</h1><br /> <?php
            ...
            <tbody> <?php                
                ...
                foreach ($rows as &$row) { ?>
                    <tr>
                        ...
                        <td><?= $row['desc_gas'] ?></td>
                        <td><?= $row['cant_gas'] ?> €</td>
                        <td colspan=2><a title='delete_<?= $row['id_bal']; ?>' href='delete.php?id_bal=<?= $row['id_bal'] ?>'>Eliminar</a></td>
                    </tr> <?php
